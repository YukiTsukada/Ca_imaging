...
hold on;plot(Time_Point(2:end),RRR_med(2:end),'r');xlabel('seconds');
...
load(FILE_thermo);
temperature = thermomap_TC(Thermo,Left,Right,Coordinates,CoordiTime,FILE);
